    ...
    return (
        <>
            <section className="w-full flex flex-col items-center gap-12">
                ...
                <div className="grid grid-cols-4 gap-[22px] w-[774px] mb-[268px]">
                    <Document />
                    <Document />
                    <Document />
                    <Document />
                ...
                <main className="relative container-table-docs px-[54px] py-12 flex flex-col gap-8">
                    {/* Table source */}
                    <div className="w-flex justify-center">
                        <table className="table-content flex flex-col gap-2">
                            <tr className="table-header rounded-lg flex">
                                ...
                                <th className="text-center w-[134px]">Tải tài liệu</th>
                            </tr>
                            {
                                dummy.map((value, index) => (
                                    <tr className="rounded-lg flex" key={index}>
                                        ...
                                        <td className="flex w-[134px] justify-center">
                                            <div>
