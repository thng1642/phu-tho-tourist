    ...
    return(
        <section className='w-full flex flex-col items-center justify-end gap-12 mb-10 '>
            ...
            <section className='grid grid-cols-[362px,_1fr] grid-rows-[80px,_1fr] w-[1520px] h-[1108px] gap-6'>
                {/* filter packs */}
                <div className='bg-[#ffffffb3] rounded-xl row-span-2 h-[1028px] px-5 backdrop-blur-[7.5px] shadow-filter shrink-0'>
                    ...
                    <div className='inline-flex flex-col items-start gap-5 w-full'>
                        <div className='p-5 flex items-center rounded-lg gap-3 w-full bg-[#0054A6]'>
                            ...
                            <p className='type-filter'>Giới thiệu</p>
                        </div>
                        <div className='p-5 flex items-center rounded-lg gap-3 w-ful'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <p className='type-filter'>Tin tức</p>
                        </div>
                        <div className='p-5 flex items-center rounded-lg gap-3 w-ful'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <p className='type-filter'>Sự kiện</p>
                        </div>
                        <div className='p-5 flex items-center rounded-lg gap-3 w-ful'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <p className='type-filter'>Thông báo</p>
                        </div>
                        <div className='p-5 flex items-center rounded-lg gap-3 w-ful'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <p className='type-filter'>Tin cổ đông</p>
                        </div>
                        <div className='p-5 flex items-center rounded-lg gap-3 w-ful'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <p className='type-filter'>Hoạt động tập thể</p>
                        </div>
                    </div>
                </div>
                <div className='shadow-filter rounded-xl bg-[#ffffffb3] backdrop-blur-[7.5px] shrink-0 flex items-center justify-between'>
                    {/* Search box */}
                    <div className='w-[314px] flex items-center bg-white rounded-md gap-[10px] my-5 ml-5 px-4'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <input type="text" name="search-feed" id="" placeholder='Tìm kiếm' className='text-search-box py-[10px] w-full pr-8 focus:outline-none'/>
                    </div>
                    {/* Date picker */}
                    <div className='w-[322px] h-10 relative'>
                        <div className='flex gap-2 text-[#858585] w-[322px] justify-between shrink-0 items-center'>
                            <div className='flex px-3 shrink-0 h-10 items-center justify-between w-[150px] self-stretch rounded-md bg-white'>
