...
export default function Feed() {
    return(
        <section className='bg-[#0e0d0d42] w-full flex flex-col justify-end items-center gap-12'>
            ...
            <section className='grid grid-cols-[362px,_1fr] grid-rows-[80px,_1fr] w-[1520px] h-[1108px] gap-6'>
                ...
                <div className='shadow-filter rounded-xl bg-[#ffffffb3] backdrop-blur-[7.5px] shrink-0'>
